...
You can install GNOME Fuzzy App Search from the AUR package [`gnome-shell-extension-fuzzy-app-search-git`](https://aur.archlinux.org/packages/gnome-shell-extension-fuzzy-app-search-git).
