local function setup(_, options)
  ...
  local theme = {
    ...
    stashes_color = options.stashes_color or "bright cyan",
    state_color = options.state_color or "red",
    staged_color = options.staged_color or "green",
    unstaged_color = options.unstaged_color or "yellow",
    untracked_color = options.untracked_color or "cyan",
  }
  ...
  function Header:githead()
    ...
    return ui.Line { prefix, branch, state, staged, unstaged, untracked, stashes, behind, ahead }
  end
